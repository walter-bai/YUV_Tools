...
TEST_F(FrameConverterTest, SelfConversion)
{
    {
        // Y410
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:y410", "Test_1920x1080_1frame.y410", "-o:y410", "out.yuv" };
    ...
    {
        // AYUV
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:ayuv", "Test_1920x1080_1frame.ayuv", "-o:ayuv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // I440
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:i440", "Test_1918x1078_1frame.i440", "-o:i440", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // YUYV
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:yuyv", "Test_1918x1078_1frame.yuyv", "-o:yuyv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // NV12
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:nv12", "Test_3840x2160_1frame.nv12", "-o:nv12", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // I400
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:i400", "Test_3840x2160_1frame.i400", "-o:i400", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
...
TEST_F(FrameConverterTest, ChromaSampling444)
{
    {
        // 444 -> 440
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:ayuv", "Test_1920x1080_1frame.ayuv", "-o:i440", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 444 -> 422
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:ayuv", "Test_1920x1080_1frame.ayuv", "-o:yuyv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 444 -> 420
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:ayuv", "Test_1920x1080_1frame.ayuv", "-o:nv12", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 444 -> 400
        const char* cmdline[] = { "-w", "1920", "-h", "1080", "-i:ayuv", "Test_1920x1080_1frame.ayuv", "-o:i400", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
...
TEST_F(FrameConverterTest, ChromaSampling440)
{
    {
        // 440 -> 444
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:i440", "Test_1918x1078_1frame.i440", "-o:ayuv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 440 -> 422
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:i440", "Test_1918x1078_1frame.i440", "-o:yuyv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 440 -> 420
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:i440", "Test_1918x1078_1frame.i440", "-o:i420", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 440 -> 400
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:i440", "Test_1918x1078_1frame.i440", "-o:i400", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
...
TEST_F(FrameConverterTest, ChromaSampling422)
{
    {
        // 422 -> 444
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:yuyv", "Test_1918x1078_1frame.yuyv", "-o:ayuv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 422 -> 440
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:yuyv", "Test_1918x1078_1frame.yuyv", "-o:i440", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 422 -> 420
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:yuyv", "Test_1918x1078_1frame.yuyv", "-o:i420", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 422 -> 400
        const char* cmdline[] = { "-w", "1918", "-h", "1078", "-i:yuyv", "Test_1918x1078_1frame.yuyv", "-o:i400", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
...
TEST_F(FrameConverterTest, ChromaSampling420)
{
    {
        // 420 -> 444
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:nv12", "Test_3840x2160_1frame.nv12", "-o:ayuv", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 420 -> 440
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:nv12", "Test_3840x2160_1frame.nv12", "-o:i440", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 420 -> 422
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:nv12", "Test_3840x2160_1frame.nv12", "-o:i422", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 420 -> 400
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:nv12", "Test_3840x2160_1frame.nv12", "-o:i400", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
...
TEST_F(FrameConverterTest, ChromaSampling400)
{
    {
        // 400 -> 444
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:i400", "Test_3840x2160_1frame.i400", "-o:i444", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 400 -> 440
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:i400", "Test_3840x2160_1frame.i400", "-o:i440", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 400 -> 422
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:i400", "Test_3840x2160_1frame.i400", "-o:i422", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
    ...
    {
        // 400 -> 420
        const char* cmdline[] = { "-w", "3840", "-h", "2160", "-i:i400", "Test_3840x2160_1frame.i400", "-o:i420", "out.yuv" };
        converter::FrameConverter<TestDataIStream, TestDataOStream> cvt;
        cvt.Execute(sizeof(cmdline) / sizeof(cmdline[0]), cmdline);
